      ...
      <section className="homepage_main">
        <div className="homepage_main_content">
          <div className="left_side">
            <Link to="/timeline/a2" className="wrapper-message-user-home">
              <div className="card1">
                <div className="image_card_a2"></div>
                <div className="text">
          ...
          <div className="right_side">
            ...
            >
              <div className="card2">
                <div className="image_card_a2"></div>
                <div className="text">
                  <p>Recalling the past</p>
                  <h2>Describe activities you did the day before</h2>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="card3">
                <div className="image_card_3_a2"></div>
                <div className="text">
                  <p>Is A1 hard?</p>
                  <h2>You could go to the previous level (A1)</h2>
                </div>
              </div>
            </Link>
          </div>
