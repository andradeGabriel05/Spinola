  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      if (newClickedWord != clickedWordState) {
        ...
        console.log(newClickedWord); // valor atualizado
      }
      if (videoRef.current.currentTime > 148.92) {
    ...
    return () => clearInterval(interval); // para o interval
  }, [clickedWordState]);
  ...
  return (
    <div className="container_music_video">
      <div className="wrapper_video_choice">
        ...
        >
          <source
            src="/public/Le ciel, le soleil et la mer.mp4"
            type="video/mp4"
          />
        </video>
